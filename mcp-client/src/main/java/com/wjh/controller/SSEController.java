...
public class SSEController {
    ...
    /**
     * SSE发送单个消息 - CUSTOM_EVENT
     * @return
     */
    @GetMapping(path = "sendMessageCustom")
    public Object sendMessageCustom(@RequestParam String userId,@RequestParam String message) throws InterruptedException {
        for (int i = 0; i < 10; i++) {
            Thread.sleep(200);
